...
<script type="text/javascript">
	function checkForm(){//检查form表单提交的数据
		var nickName=$("#nickName").val();//昵称
	    var content=$("#content").val();//留言内容
	    if(""==nickName){
	    	$("#error").html("昵称不能为空");
	    	return false;
	    }
					...
					<dl>
						...
						<dd class="author">
							...
							<c:if test="${not empty comment.replyContent }">
								<dd>
									官方回复 @${comment.nickName }： ${comment.replyContent }&nbsp;&nbsp;
									<span class="timer">
			...
			<form action="comment?oper=save" method="post" onsubmit="return checkForm()">
				<table>
					<tr>
						...
						<td><input class="text" type="text"  id="nickName"  name="nickName1" />
						</td>
					</tr>
					<tr>
